...
public class Data_Utility extends Constant {
	...
	public static void getExcelFileScenario(String Path, int TCCount) throws Exception {
			...
			TotalRowsNo = ExcelWSheet.getLastRowNum() +1;
				...
				for (int i=1; i<=TCCount; i++)
				{
					 ...
					 String TestCaseName =  ExcelWSheet.getRow(i).getCell(2).toString();
					 Data_Utility.setTestCase(TestCaseName);
					 Keyword_Ref = ExcelWSheet.getRow(i).getCell(1);
					 //Method
					 //if (ExecutionFlag.toString().equals("Yes")) {
						 System.out.println(ExecutionFlag);
						 System.out.println(TestCase);
						 Data_Utility.AddKeywords(Keyword_Ref, Path);
	...
	public static List<String> AddKeywords(XSSFCell keyword_Ref2, String Path) throws Exception {
		...
		try {
			...
			for (int i=1; i<=TotalRowsTestScenario-1; i++)
			{
			 ...
			 Data_Utility.setList(KeywordList1);
	...
	public static Hashtable<String, String> TestDataInteraction(String Path,String SheetName, String TestCaseName) throws Exception {
	...
	public static int TotalActiveRows( String Path, String FileName) throws Exception {
		...
		try {
				...
				TotalRowsNo = ExcelWSheet.getLastRowNum() +1;
				Data_Utility.setList(TotalRowsNo);
	...
	public static void setList(ArrayList KeywordList1) {
	    Data_Utility.KeywordList1 = KeywordList1;
	}
	...
	public static void setList(int TotalRowsNo) {
	    Data_Utility.TotalRowsNo = TotalRowsNo;
	}
	...
	public static void setTestCase(String testCaseName) {
	  Data_Utility.testCaseName = testCaseName;
	}
	...
	Data_Utility.TestData_dict = TestData_dict;
	}
